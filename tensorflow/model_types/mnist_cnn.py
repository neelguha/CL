...
class CNN:
    ...
    def __init__(self, w_initial, b_initial):
        ...
        self.y_ = tf.placeholder(tf.float32, [None, 10], name="output")

        # Build the graph for the deep net
        y_conv, keep_prob = self.deepnn(self.x, w_initial, b_initial)
    ...
    def train_model(self, train_data, test_data, n=20000):
    ...
    def deepnn(self, x, w_initial, b_initial):
        ...
        with tf.name_scope('fc2'):
            self.W_fc2 = weight_variable([1024, 10], name= "final_W", initial=w_initial)
            self.b_fc2 = bias_variable([10], name= "final_b", initial=b_initial)
