...
class Solver():
    ...
    def __init__(self, m1, m2):
        ...
        self.w1 = tf.Variable(tf.truncated_normal(m1_w1.shape, stddev=0.1), dtype=tf.float32)
        ...
        self.b1 = tf.Variable(tf.truncated_normal(m1_b1.shape, stddev=0.1), dtype=tf.float32)
        ...
        self.w2 = tf.Variable(tf.truncated_normal(m1_w2.shape, stddev=0.1), dtype=tf.float32)
        ...
        self.b2 = tf.Variable(tf.truncated_normal(m1_b2.shape, stddev=0.1), dtype=tf.float32)
        ...
        self.logger.info("Solver Loss: %f" % self.sess.run(self.loss))
